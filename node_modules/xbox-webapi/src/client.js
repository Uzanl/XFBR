...
module.exports = function(config){
    ...
    return {
        ...
        getAccessToken: function() {
          //  return this._authentication.loadTokens();
            return this._authentication._tokens.oauth;
        },
        ...
        revokeAccessToken: function(){
            return this._authentication.revokeOAuthToken()
        },

        clearTokens: function(){
            return this._authentication.clearTokens()
        },
